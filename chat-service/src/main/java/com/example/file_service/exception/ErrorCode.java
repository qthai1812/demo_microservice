...
public enum ErrorCode {
    ...
    USER_NOT_FOUND(1001,"USER PROFILE NOT EXISTS IN DATABASE",HttpStatus.BAD_REQUEST),
    CONVERSATION_NOT_FOUND(1001,"CONVERSATION NOT EXISTS IN DATABASE",HttpStatus.BAD_REQUEST),
